...
public class VerifyMAC extends JFrame {
	...
	public VerifyMAC() {
		...
		textFieldResult.setFont(new Font("隶书", Font.PLAIN, 24));
		...
		buttonBack.setFont(new Font("隶书", Font.PLAIN, 24));
		...
		checkBoxHmacMD5.setFont(new Font("微软雅黑", Font.BOLD, 18));
		...
		checkBoxHmacSHA1.setFont(new Font("微软雅黑", Font.BOLD, 18));
		...
		checkBoxHmacSHA256.setFont(new Font("微软雅黑", Font.BOLD, 18));
		...
		checkBoxHmacMD2.setFont(new Font("微软雅黑", Font.BOLD, 18));
		...
		checkBoxHmacMD4.setFont(new Font("微软雅黑", Font.BOLD, 18));
		...
		checkBoxHmacMD128.setFont(new Font("微软雅黑", Font.BOLD, 18));
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					if(macstr.equals(macstring)){
						textFieldResult.setText("校验通过！");
					}
					else
					{
						textFieldResult.setText("校验不通过！");
					}
		...
		buttonVerify.setFont(new Font("隶书", Font.PLAIN, 30));
