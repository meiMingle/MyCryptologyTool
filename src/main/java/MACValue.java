...
public class MACValue extends JFrame {
	...
	public MACValue() {
		...
		lblmac.setFont(new Font("隶书", Font.PLAIN, 26));
		...
		label.setFont(new Font("隶书", Font.PLAIN, 26));
		...
		label_1.setFont(new Font("隶书", Font.PLAIN, 26));
		...
		label_2.setFont(new Font("隶书", Font.PLAIN, 26));
		...
		chckbxHmacMD5.setFont(new Font("微软雅黑", Font.BOLD, 18));
		...
		chckbxHmacSHA1.setFont(new Font("微软雅黑", Font.BOLD, 18));
		...
		chckbxHmacSHA256.setFont(new Font("微软雅黑", Font.BOLD, 18));
		...
		chckbxHmacMD2.setFont(new Font("微软雅黑", Font.BOLD, 18));
		...
		chckbxHmacMD4.setFont(new Font("微软雅黑", Font.BOLD, 18));
		...
		chckbxHmacripeMD128.setFont(new Font("微软雅黑", Font.BOLD, 18));
		...
		lblmac_1.setFont(new Font("隶书", Font.PLAIN, 26));
		lblmac_1.setBounds(27, 481, 367, 46);
		contentPane.add(lblmac_1);
		
		textFieldMACValue = new JTextField();
		textFieldMACValue.setFont(new Font("微软雅黑", Font.PLAIN, 10));
		   ...
		   if(Arrays.equals(password1,password2))
		   {
			   try {
				   ...
				   MessageDigest md;
					...
					byte[] hashvalue=md.digest(password.getBytes());     //构建密码摘要
					
					if(chckbxHmacMD2.isSelected())
					{
						SecretKeySpec keySpec=new SecretKeySpec(hashvalue, "HmacMD2");
						
						Mac mac=Mac.getInstance("HmacMD2");           //MAC对象
						
						mac.init(keySpec);                //密钥初始化
						
						macValue=mac.doFinal(string.getBytes()); //计算mac码值
				...
				// TODO Auto-generated catch block
				JOptionPane.showMessageDialog(null, "算法名出错！");
				e1.printStackTrace();
		...
		buttonCalculate.setFont(new Font("隶书", Font.BOLD, 26));
		...
		buttonBack.setFont(new Font("隶书", Font.PLAIN, 22));
